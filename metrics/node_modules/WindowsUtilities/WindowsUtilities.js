 ...
 *
 * @param hwnd {Number} The window handle.
 ...
 *
 * @param indirectString {String} A string in the form of "@dllname,-resourceID" (consult MSDN for other forms).
 ...
 * @param returnCode {String|Number} [optional] The return code of the function causing the error.
